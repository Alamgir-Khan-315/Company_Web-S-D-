...
const Entitlement = ({ sendDataToParent }) => {
    ...
    const [DataEntitlement, setDataEntitlement] = useState({
        ot: "", advance: "", loan_amount: "", loan: "", alwc: "", n: "", food: "", transport: "",
        sun_ot: "", cony: "", strength: "", envolope: ""
    });
        ...
        <div>
            ...
            <div className="form-body grid md:grid-cols-2 place-items-center p-3">
                ...
                <div className="packing flex w-[80%] items-center gap-5 p-2">
                    ...
                    <select className="input" id="" name="food" onChange={handleInputData}>
                        <option>Small</option>
                        <option>Medium</option>
                        <option>Large</option>
                    </select>
                ...
                <div className="packing flex w-[80%] items-center gap-5 p-2">
                    ...
                    <select className="input" id="" name="transport" onChange={handleInputData}>
                        <option>Small</option>
                        <option>Medium</option>
                        <option>Large</option>
                    </select>
                ...
                <div className="weight flex w-[80%] items-center gap-5 p-2">
                    ...
                    <input className="input" type="" name="sun_ot" onChange={handleInputData} />
                </div>

                <div className="weight flex w-[80%] items-center gap-5 p-2">
                    <h2 className="label">Cony :</h2>
                    <input className="input" type="" name="cony" onChange={handleInputData} />
                </div>

                <div className="packing flex w-[80%] items-center gap-5 p-2">
                    <h2 className="label">Strength :</h2>
                    <select className="input" id="" name="strength" onChange={handleInputData}>
                        <option>Small</option>
                        <option>Medium</option>
                        <option>Large</option>
                    </select>
                ...
                <div className="packing flex w-[80%] items-center gap-5 p-2">
                    ...
                    <select className="input" id="" name="envelope" onChange={handleInputData}>
                        <option>Small</option>
                        <option>Medium</option>
                        <option>Large</option>
                    </select>
