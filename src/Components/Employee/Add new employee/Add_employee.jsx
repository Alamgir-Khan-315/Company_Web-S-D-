    ...
    return (
        <div className="main h-full w-full">
            ...
            <div className="navigation ml-5 p-2 flex items-center font-semibold text-gray-500">
                <Link to="/"><h1 className="text hover:text-black cursor-pointer">Home</h1></Link> &nbsp; / &nbsp; <h1 className="text-black cursor-pointer">Add Employee</h1>
            </div>

            <div className="box mt-[1rem] !p-[1rem]">

                <div className="title"><h1 className="heading">Add New Employee</h1></div>
